...
domReady(function() {
  ...
  var roomid = 1443712566;
  var peerid = 0;
  var name = "guest";
  var email = "";
  var isVideo = 0;

  //https://local.peercall.vn/mobile/?appid=MTQ0MzcxMjU2Ng&n=name&e=email
  console.log("ready to start agent");

/*
  roomid = parseInt(Base64.decode(getURLParameter('appid')));
  if ( isNaN(roomid) ) {
     console.log("FIXME get appid: " + JSON.stringify($peercall.i));
     roomid = parseInt(Base64.decode($peercall.i));
  }
...
*/
  ...
  document.getElementById("startBtn").addEventListener("click", function() {
     room.init(roomid,peerid,name,email,1,0);
  });
  document.getElementById("viewBtn").addEventListener("click", function() {
     room.init(roomid,peerid,name,email,0,1);
  });
